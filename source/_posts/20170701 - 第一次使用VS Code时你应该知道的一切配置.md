...
![img](source/assets/images/20200619_0133%201%201.png)
...
![img](source/assets/images/20210930_1930%201%201.png)
...
![img](source/assets/images/20190329_2120%201%201.png)
...
![img](source/assets/images/20210623-2115%201%201.gif)
...
![img](source/assets/images/20190329_1750_2%201%201.png)
...
![img](source/assets/images/20190329_2110%201%201.png)
...
![img](source/assets/images/20190414_1751%201%201.png)

### 5、使用命令行启动 VS Code

（1）输入快捷键「Cmd + Shift + P 」，选择`install code command`：

![img](source/assets/images/20191103_1327%201%201.png)
...
![img](source/assets/images/20210930_2009%201%201.png)

**方式2**：点击软件右下角的设置图标：

![img](source/assets/images/20210930_2016%201%201.png)

### 1、修改颜色主题

选择菜单栏「Code --> 首选项 --> 颜色主题」：

![img](source/assets/images/20210930_2017%201%201.png)

在弹出的对话框中，挑选你一个你喜欢的的颜色主题吧：

![img](source/assets/images/20210930_2018%201%201.png)

### 2、面包屑（Breadcrumb）

打开 VS Code 的设置项，选择「用户设置 -> 工作台 -> 导航路径」，如下图所示：

![img](source/assets/images/20191108_1550%201%201.png)

上图中，将红框部分打钩即可。

设置成功后，我们就可以查看到当前文件的「层级结构」，非常方便。如下图所示：

![img](source/assets/images/20190415_2009%201%201.png)
...
![img](source/assets/images/20190417_2140%201%201.png)
...
![img](source/assets/images/20190417_2156%201%201.png)
...
![img](source/assets/images/20190417_2216%201%201.png)
...
![img](source/assets/images/20190417_2213%201%201.png)
...
![img](source/assets/images/20190417_2205%201%201.png)

- **editor.insertSpaces**：按 Tab 键时插入空格（默认）。截图如下：

![img](source/assets/images/20190417_2207%201%201.png)

- **editor.tabSize**：一个制表符默认等于四个空格。截图如下：

![img](source/assets/images/20190417_2209%201%201.png)
...
![img](source/assets/images/20190417_2221%201%201.png)
...
![img](source/assets/images/20190418_1758%201%201.png)
...
![img](source/assets/images/20190329_1757%201%201.png)
...
![img](source/assets/images/20190415_2052%201%201.png)
...
![img](source/assets/images/20191108_1655%201%201.png)
...
![img](source/assets/images/20190415_2107%201%201.png)
...
![img](source/assets/images/20190418_1850%201%201.png)
...
![img](source/assets/images/20190418_2022%201%201.png)

那么，就可以创建多层子文件夹，效果如下：

![img](source/assets/images/20190418_2023%201%201.png)
...
![img](source/assets/images/20190418_1907%201%201.png)
...
![img](source/assets/images/20191108_1553_2%201%201.png)
...
![img](source/assets/images/20211009_1400%201%201.png)

安装了 GitLens 之后是这样的：

![img](source/assets/images/20211009_1430%201%201.png)
...
![img](data:image/svg+xml,%3Csvg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2062 1842"%3E%3C/svg%3E)
...
![img](source/assets/images/20200618_2100%201%201.jpeg)
...
![img](source/assets/images/20190418_1958%201%201.png)
...
![img](source/assets/images/20200618_2246%201%201.png)
...
![img](source/assets/images/20190418_1937%201%201.png)
...
![img](source/assets/images/20190418_2012%201%201.png)

上图中，点击红框部分，登录后就可以分享你的工作空间了。

![img](source/assets/images/20190418_2005%201%201.png)
...
![img](source/assets/images/20211008_1713%201%201.png)

（2）选择需要同步的配置：

![img](source/assets/images/20211008_1716%201%201.png)

（3）通过Microsoft或者GitHub账号登录。 上图中，点击“登录并打开”，然后弹出如下界面：

![img](source/assets/images/20211008_1717%201%201.png)

上图中，使用 微软账号或者 GitHub账号登录：

![img](source/assets/images/20211008_1718%201%201.png)

（4）同步完成后，菜单栏会显示“首先项同步已打开”，最左侧也会多出一个同步图标，如下图所示：

![img](source/assets/images/20211008_1720%201%201.png)
