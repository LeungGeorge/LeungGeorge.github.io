...
![20191024171029](source/_posts/assets/images/20191024171029.png)
...
![20191025000537](source/_posts/assets/images/20191025000537.png)
![20191025000736](source/_posts/assets/images/20191025000736.png)
![20191025000755](source/_posts/assets/images/20191025000755.png)
...
![20191009201627](source/_posts/assets/images/20191009201627.png)
...
![20191009201726.png](source/_posts/assets/images/20191009201726.png)
![20191024172010.png](source/_posts/assets/images/20191024172010.png)
![20191024171744.png](source/_posts/assets/images/20191024171744.png)

2. 读取失败（访问不存在的键）
执行 `GET("k4")` 读取键值对。缺失次数（missCount）+1，淘汰链表顺序不变，LRUCache 状态：
![20191009202004.png](source/_posts/assets/images/20191009202004.png)
...
![20191009202529](source/_posts/assets/images/20191009202529.png)
...
k5 键值对，插入到链表头部位置：
![20191009202241](source/_posts/assets/images/20191009202241.png)
...
![20191009194655](source/_posts/assets/images/20191009194655.png)
...
![20191009195606](source/_posts/assets/images/20191009195606.png)
...
![20191009195650.png](source/_posts/assets/images/20191009195650.png)

2. 创建 freqEntry(freq = 1) 新节点（插入到 freq = 0 节点之后），然后把 key = lfuItem1 的键值对添加到节点 items 中，并修改命中次数（hitCount）：
![20191009200747.png](source/_posts/assets/images/20191009200747.png)
...
1. 从链表首部节点开始选择待淘汰键值对：
![20191009200845.png](source/_posts/assets/images/20191009200845.png)

2. 淘汰 `步骤 1` 中选定的键值对：
![20191009200926.png](source/_posts/assets/images/20191009200926.png)

3. 新节点加入到链表首部节点（freq = 0）中，并更新 items：
![20191009202934.png](source/_posts/assets/images/20191009202934.png)
...
![20191012163848](source/_posts/assets/images/20191012163848.png)


相比 LRUCache，LFUCache 来讲，ARCCache 的逻辑复杂了很多。如图，给出 ARCCache 键值对转移状态图：
![20191025102517](source/_posts/assets/images/20191025102517.png)
...
![20191012165433](source/_posts/assets/images/20191012165433.png)
...
![20191025003420](source/_posts/assets/images/20191025003420.png)

2.  可以看到，t1 中的其他键值对，依次被移动到了 t2 中：
![20191025003158](/images

3. 再次执行 `gc.Get("k2")` 操作时，由于键值已经在 t2 中，会改变键值对的排序：
![20191025005129](source/_posts/assets/images/20191025005129.png)

4. 再次执行 `gc.Set("k1", "v1")` 操作时，由于键值对已经在 b1 中，则会把 k1 捞出来，并且放到 t2 中（认为是高频访问）：
![20191025005827](source/_posts/assets/images/20191025005827.png)
