...
gcache 的回调函数原型（定制操作），在 cache.go 中定义：
...
<img src="https://raw.githubusercontent.com/LeungGeorge/assets/master/images/20191012144841.png" width="80%">

> 键值对状态图与失效时间有关，给一个状态流转图吧。  
> ARCCache 不再像 LRUCache、LFUCache 一样，给出设置键值对时的中间过程。   
> 兄弟，我感觉这个图我画不好了！这个，太难了。。。  
...
gc.Get("k3")
```
可以看到，t1 的键值对被移动到了 t2 和 b1 中：
<img src="https://raw.githubusercontent.com/LeungGeorge/assets/master/images/20191012170409.png" width="80%">
...
当缓存满时新增键值对，ARCCache 会选择性淘汰 t1，b1，b2 中的数据（参考 SET 方法）。
