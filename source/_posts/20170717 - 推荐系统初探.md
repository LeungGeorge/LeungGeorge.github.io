...
**相似度计算：**   
（1）Jaccard公式  
![image](images/jaccard公式.png)  
（2）余弦相似度  
![image](images/余弦相似度.png)   
其中，N(u),N(v)分别代表用户u，v的兴趣集合。  
**用户行为记录表：**  
![image](images/用户行为记录表.png)   
如图，用户A对物品{a, b, d}有过行为，用户B对物品{a, c}有过行为，利用余弦相似度公式计算用户A和用户B的兴趣相似度为:  
![image](images/用户A和用户B的相似度.png) 
**用户相似度矩阵：**
...
**相似度计算：**  
![image](images/基于内容的相似度计算公式.png)  
**相似度矩阵：**  
![image](images/基于内容的相似度矩阵.png)   
...
**豆瓣图书推荐：**  
![image](images/豆瓣猜.png)    
**豆瓣电影推荐：**  
![image](images/豆瓣电影推荐.png)   
...
[comment]:**感兴趣的人：**  
[comment]:![image](images/感兴趣的人推荐.png)   
[comment]:**相关问题：**  
[comment]:![image](images/站内相关问题推荐.png) 
