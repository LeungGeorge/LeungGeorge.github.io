...
![image-20230218171235871](assets/images/image-20230218171235871.png)
...
- 维护额外哈希表：链表查找必须遍历 O(N) 读取，可在缓存中维护 `map[key]*Node` 的**哈希表**来实现 O(1) 的链表查找。

![image-20220903225628251](assets/images/image-20220903225628251.png)
...
![image-20220903225607839](assets/images/image-20220903225607839.png)
...
![image-20230218171318312](assets/images/image-20230218171318312.png)
...
![image-20220903225519226](assets/images/image-20220903225519226.png)
